function [fluxstate_gurobi,grate, solverobj,stat] =  constrain_flux_regulation(model1,onreactions,offreactions,kappa,rho,epsilon,mode)
...
params.outputflag = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
kappa = [kappa(:); ones(size(setdiff(model1.rxns, offreactions)))*1E-6]; % minimizeflux through all the reactions. PFBA
